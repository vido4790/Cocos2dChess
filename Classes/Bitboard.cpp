...
const Bitboard   Bitboard::kSquareMasks[64] = {
    ...
    (0x1ULL << 0x20), (0x1ULL << 0x21), (0x1ULL << 0x22), (0x1ULL << 0x23),
    (0x1ULL << 0x24), (0x1ULL << 0x25), (0x1ULL << 0x26), (0x1ULL << 0x27),
    (0x1ULL << 0x28), (0x1ULL << 0x29), (0x1ULL << 0x2A), (0x1ULL << 0x2B),
    (0x1ULL << 0x2C), (0x1ULL << 0x2D), (0x1ULL << 0x2E), (0x1ULL << 0x2F),
    (0x1ULL << 0x30), (0x1ULL << 0x31), (0x1ULL << 0x32), (0x1ULL << 0x33),
    (0x1ULL << 0x34), (0x1ULL << 0x35), (0x1ULL << 0x36), (0x1ULL << 0x37),
    (0x1ULL << 0x38), (0x1ULL << 0x39), (0x1ULL << 0x3A), (0x1ULL << 0x3B),
    (0x1ULL << 0x3C), (0x1ULL << 0x3D), (0x1ULL << 0x3E), (0x1ULL << 0x3F)
};
